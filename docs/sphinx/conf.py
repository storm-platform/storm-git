...
"""Configuration file for the Git helper library for Storm platform documentation.
...
html_title = 'STORM_GIT'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'storm-git',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#STORM_GIT_EXAMPLE_URL = os.getenv('STORM_GIT_EXAMPLE_URL', None)
#'''
